...
if($_POST){
    ...
    if(empty($nama_member)){
        ...
        if($check > 0){
            ...
            if($insert){
                echo "<script>alert('Sukses Menambahkan Member');location.href='../html/list-member-kasir.php';</script>";
             } else {
                echo "<script>alert('Gagal Menambahkan Member');location.href='../html/tambah-member-kasir.php';</script>";
            }
        }
    }
}