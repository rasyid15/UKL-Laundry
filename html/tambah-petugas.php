            ...
            <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                      <li class="breadcrumb-item">
                        <a href="list-petugas.php">Petugas</a>
                      </li>
                      <li class="breadcrumb-item active">
                        <a href="tambah-petugas.php">Add Petugas</a>
                      </li>
                    </ol>
                  </nav>
              <div class="row">
              <div class="col-md-12">
                  <div class="card mb-4">
                    <form action="../php/proses-tambah-petugas.php" method="POST">
                    <div class="card-body">
                      <div class="mb-3">
                  ...
                  <input type="submit" name="simpan" value="Add Petugas" class="btn btn-primary">
                </div>
                </form>
              </div>
            </div>
