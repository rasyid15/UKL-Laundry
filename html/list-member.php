        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                <h2 class="mb-3">List Member</h2>
                <div class="card">
                <div class="col-lg-12 mb-4 order-0">
                    <div class="col-lg-15 mb-4 mb-xl-0">                    
                      ...
                      <div class="table-responsive text-nowrap">
                        ...
                        <td>
                        <a href="ubah-member.php?id=<?= $data_member['id'] ?>" class="btn btn-success">Ubah</a> | 
                        <a href="../php/hapus-member.php?id=<?= $data_member['id'] ?>" onclick="return confirm ('Apakah anda yakin menghapus data ini ?')"
                        ...
                        <a href="tambah-member.php" class="btn btn-primary mt-2">Tambah Member</a>
                        </div>                                                 
                        </div>
                      </div>
                    </div>
