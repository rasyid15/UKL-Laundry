              ...
              <div class="card">
                <div class="col-lg-12 mb-4 order-0">
                    <div class="col-lg-15 mb-4 mb-xl-0">                    
                      ...
                      <a href="ubah-petugas.php?id=<?= $data_petugas['id'] ?>" class="btn btn-success">Ubah</a> |         
                        <a href="../php/hapus-petugas.php?id=<?= $data_petugas['id'] ?>" onclick="return confirm ('Apakah anda yakin menghapus data ini ?')"
                        ...
                        <a href="tambah-petugas.php" class="btn btn-primary mt-3">Add Petugas</a>
                        </div>                                                 
                        </div>
                      </div>
                    </div>
