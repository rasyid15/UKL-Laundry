          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <?php
                ...
                ?>
              <div class="col-md-12">
                <form action="../php/proses-ubah-paket.php?id=<?= $_GET['id'] ?>" method="post">
                  <div class="card mb-4">
                    <div class="card-body">
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input
                          type="text"
                          class="form-control"
                          value="<?= $data_paket['harga'] ?>"
                          name="harga"
                        />
                      </div>
                      
                    <input type="submit" name="simpan" value="Ubah Paket" class="btn btn-primary mt-3">
                  </form>
                </div>
              </div>
            </div>
