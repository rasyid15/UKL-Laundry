            ...
            <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                      <li class="breadcrumb-item">
                        <a href="index-owner.php">Dashboard</a>
                      </li>
                      <li class="breadcrumb-item active">
                        <a href="detail-transaksi-owner.php">Detail Transaksi</a>
                      </li>
                    </ol>
                  </nav>
              <div class="row">
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <!-- detail transaksi end -->
                        <input type="submit" name="simpan" value="Refresh" class="btn btn-warning mt-3" onclick="const refreshBtn = document.getElementById('refresh'); window.location.reload(true);" id="refresh">
